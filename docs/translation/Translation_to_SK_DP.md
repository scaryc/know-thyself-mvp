...
- **Lines**: 1,198
- **Patient**: J�n (male)  Already Slovak name!
- **Key Medical Content**:
...
- [ ] **TBI Patient** (`scenarios/sk/tbi_patient_v2_0_final.json`) - 6-8 hours
  - Translate dispatch info, scene description
  - Translate patient dialogue (J�n) - male, formal vy
...
- Example (Slovak):
  -  Correct: "Ako sa **c�tite**?" (How do **you** [formal] feel?)
  - L Incorrect: "Ako sa **c�tia**?" (How do **you** [informal] feel?)

**Add to Core Agent Prompt**:
```
IMPORTANT: When simulating patient speech in Slovak, ALWAYS use formal address (vy form).
- Use "vy" not "ty"
- Conjugate verbs appropriately: c�tite (not c�tia), m�te (not m�a), viete (not viea)
...
1. FORMAL ADDRESS (VY):
   ...
   - Verbs: c�tite, m�te, viete, potrebujete, m�~ete
...
3. NATURAL DISTRESS EXPRESSIONS:
   - Calm: "Bol� ma to." (It hurts.)
   - Distressed: "Ve>mi ma to bol�!" (It hurts a lot!)
   - Critical: "Nem�~em d�chae! Pom�~te mi!" (I can't breathe! Help me!)

4. MEDICAL TERMS:
   - Use Slovak medical terminology, not English
   - Example: "d�chanie" not "breathing", "bolese" not "pain"
```
...
|---------|--------|-------|
| Blood pressure | Krvn� tlak | Standard term |
| Heart rate | Srdcov� frekvencia / Pulz | Both acceptable |
| Respiratory rate | Dychov� frekvencia | Standard term |
| Oxygen saturation | Satur�cia kysl�kom | Standard term |
| Glasgow Coma Scale | Glasgowsk� k�ma ak�la | Same abbreviation (GCS) |
| SAMPLE history | SAMPLE anamn�za | Acronym kept, may need explanation |
| Chest pain | Bolese na hrudn�ku | Standard |
| Shortness of breath | D�chavi
nose | Standard |
| Seizure | Z�chvat / KU
e | Context-dependent |
| Traumatic brain injury | Traumatick� poranenie mozgu | Standard |
...
| Epinephrine | Epinefr�n / Adrenal�n | Both used |
| Nitroglycerin | Nitroglycer�n | Same |
| Aspirin | Kyselina acetylsalicylov� / Aspir�n | Medical term / common name |
| Morphine | Morf�n | Same |
...
```
"da~k� d�chavi
nose, bolese na hrudn�ku, aok."
"Pr�aern� bolese hlavy, nevo>nose, zm�tenose."
```
...
3. Slovensk� komora z�chran�rov (Slovak Chamber of Paramedics) terminology guides
